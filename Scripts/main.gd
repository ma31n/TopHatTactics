...
func _on_button_pressed() -> void:
	...
	if(Global.gamestate==-1):
		...
		match level:
			...
			2:
				match wave:
					1: enemies=[["EnemyTopHat",0,1],["EnemyTopHat",1,0.05],["EnemyTopHat",0,1],["EnemyTopHat",1,0.05],["EnemyTopHat",0,1],["EnemyTopHat",1,0.05],["EnemyTopHatSpeedy",0,1],["EnemyTopHatSpeedy",1,0.05],["NecessaryEvil"]]
					2: enemies=[["EnemyTopHatSpeedy",0,1],["EnemyTopHatSpeedy",1,0.05],["EnemyTopHat",0,0.7],["EnemyTopHat",1,0.05],["EnemyTopHat",0,0.7],["EnemyTopHatSpeedy",1,0.05],["EnemyTopHatSpeedy",1,0.7],["NecessaryEvil"]]
					...
					5: enemies=[["EnemyTopHat",0,1],["EnemyTopHat",1,0.05],["EnemyTopHat",0,0.5],["EnemyTopHat",1,0.05],["EnemyHardHat",0,1],["EnemyHardHat",1,0.05],["EnemyPropellerHat",0,1],["EnemyPropellerHat",1,0.05],["EnemyHardHat",0,0.5],["EnemyHardHat",1,0.05],["NecessaryEvil"]]
			...
			3:
				match wave:
					1: enemies=[["EnemyTopHatSpeedy",0,0.05],["EnemyTopHatSpeedy",1,0.05],["EnemyTopHat",0,1],["EnemyTopHat",1,0.05],["EnemyTopHatSpeedy",0,1],["EnemyTopHatSpeedy",1,0.05],["EnemyTopHat",0,1],["EnemyTopHat",1,0.05],["EnemyTopHatSpeedy",0,1],["EnemyTopHatSpeedy",1,0.05],["NecessaryEvil"]]
					2: enemies=[["EnemyHardHat",0,1],["EnemyHardHat",1,0.05],["EnemyHardHat",0,1],["EnemyHardHat",1,0.05],["EnemyTopHat",0,0.3],["EnemyTopHat",0,0.3],["EnemyTopHat",0,0.3],["EnemyTopHatSpeedy",1,0.05],["EnemyTopHat",0,0.3],["EnemyTopHat",0,0.3],["EnemyTopHat",0,0.3],["EnemyTopHatSpeedy",1,0.05],["EnemyPropellerHat",0,1],["EnemyPropellerHat",1,0.05],["NecessaryEvil"]]
					3: enemies=[["EnemyPropellerHat",0,1],["EnemyPropellerHat",0,0.8],["EnemyPropellerHat",0,0.8],["EnemyJesterHat",1,0.05],["EnemyHardHat",0,0.7],["EnemyHardHat",0,0.7],["EnemyJesterHat",1,0.05],["EnemyTopHatSpeedy",0,0.3],["EnemyTopHatSpeedy",0,0.3],["EnemyTopHatSpeedy",0,0.3],["EnemyTopHatSpeedy",0,0.3],["EnemyPropellerHat",1,0.05],["NecessaryEvil"]]
					4: enemies=[["EnemyPilotHat",0,1],["EnemyPilotHat",1,0.4],["EnemyPilotHat",0,0.4],["EnemyPilotHat",1,0.4],["EnemyPropellerHat",0,1],["EnemyPropellerHat",0,0.4],["EnemyPropellerHat",0,0.4],["EnemyPropellerHat",0,0.4],["EnemyJesterHat",0,1],["EnemyPilotHat",1,0.5],["EnemyPilotHat",1,0.5],["NecessaryEvil"]]
					5: enemies=[["EnemyTopHatSpeedy",0,1],["EnemyTopHatSpeedy",0,0.3],["EnemyTopHatSpeedy",0,0.3],["EnemyTopHatSpeedy",0,0.3],["EnemyTopHatSpeedy",0,0.3],["EnemyHardHatBlue",1,0.05],["EnemyTopHatSpeedy",0,0.3],["EnemyTopHatSpeedy",1,0.3],["EnemyTopHatSpeedy",0,0.3],["EnemyTopHatSpeedy",0,0.3],["EnemyHardHatBlue",1,0.05],["EnemyHardHatBlue",0,1],["NecessaryEvil"]]
					6: enemies=[["EnemyHardHatBlue",0,1],["EnemyHardHatBlue",0,1],["EnemyHardHatBlue",0,1],["EnemyJesterHat",0,1],["EnemyPilotHat",1,1],["EnemyPilotHat",1,0.7],["EnemyPilotHat",1,0.7],["EnemyJesterHat",0,1],["EnemyHardHatBlue",0,1],["EnemyHardHatBlue",0,1],["NecessaryEvil"]]
					7: enemies=[["EnemyHardHatBlue",1,1],["EnemyHardHatBlue",1,1],["EnemyJesterHat",1,1],["EnemyHardHatBlue",1,1],["EnemyHardHatBlue",1,1],["EnemyPropellerHat",0,0.05],["EnemyPropellerHat",0,0.3],["EnemyPropellerHat",0,0.3],["EnemyPropellerHat",0,0.3],["EnemyPropellerHat",0,0.3],["NecessaryEvil"]]
					...
					11: enemies=[["EnemyHardHat",0,1],["EnemyHardHatBlue",0,0.5],["EnemyHardHat",0,0.5],["EnemyJesterHat",0,1],["EnemyPropellerHat",0,1],["EnemyPropellerHat",0,0.4],["EnemyPropellerHat",0,0.4],["EnemyPropellerHat",0,0.4],["EnemyPropellerHat",0,0.4],["EnemyPropellerHat",0,0.4],["EnemyPropellerHat",0,0.4],["EnemyPropellerHat",0,0.4],["EnemyFootballHat",0,1],["EnemyHardHatBlue",1,0.5],["NecessaryEvil"]]
